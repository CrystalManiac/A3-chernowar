...
["name", "ВВ Черноруси"] call _fnc_saveToTemplate; 						//this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
["spawnMarkerName", "Коридор вражеских войск"] call _fnc_saveToTemplate; 			//this line determines the name tag for the "carrier" on the map -- Example: ["spawnMarkerName", "NATO support corridor"] - ENTER ONLY ONE OPTION

["flag", "Flag_CO"] call _fnc_saveToTemplate; 						//this line determines the flag -- Example: ["flag", "Flag_NATO_F"] - ENTER ONLY ONE OPTION
...
["flagMarkerType", "flag_CO"] call _fnc_saveToTemplate; 			//this line determines the flag marker type -- Example: ["flagMarkerType", "flag_NATO"] - ENTER ONLY ONE OPTION
...
["vehiclesCargoTrucks", ["UK3CB_BAF_MAN_HX60_Cargo_Green_B_DPMT", "UK3CB_BAF_MAN_HX60_Cargo_Green_B_DPMT", "UK3CB_BAF_MAN_HX58_Cargo_Green_B_DPMT", "UK3CB_BAF_MAN_HX58_Cargo_Green_B_DPMT"]] call _fnc_saveToTemplate; 		//this line determines cargo trucks -- Example: ["vehiclesCargoTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
["vehiclesAmmoTrucks", ["UK3CB_BAF_MAN_HX60_Cargo_Green_B_DPMT", "UK3CB_BAF_MAN_HX58_Cargo_Green_B_DPMT"]] call _fnc_saveToTemplate; 		//this line determines ammo trucks -- Example: ["vehiclesAmmoTrucks", ["B_Truck_01_ammo_F"]] -- Array, can contain multiple assets
...
["vehiclesMilitiaTrucks", ["UK3CB_BAF_MAN_HX60_Cargo_Green_B_DPMT"]] call _fnc_saveToTemplate; 	//this line determines militia trucks (unarmed) -- Example: ["vehiclesMilitiaTrucks", ["B_G_Van_01_transport_F"]] -- Array, can contain multiple assets
